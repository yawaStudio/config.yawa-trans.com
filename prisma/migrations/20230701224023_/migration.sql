...
-- CreateIndex
CREATE UNIQUE INDEX "DeviceAttribution_simId_key" ON "DeviceAttribution"("simId");
...
-- AddForeignKey
ALTER TABLE "DeviceAttribution" ADD CONSTRAINT "DeviceAttribution_simId_fkey" FOREIGN KEY ("simId") REFERENCES "Sim"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
